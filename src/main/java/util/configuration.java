...
public class configuration {
	...
	public static final String observationSystem_BILIRUBIN = "http://sfb125.de/ontology/ihCCApplicationOntology/";
	public static final String observationCode_HEPATITIS_B_CODE = "chronic_hepatitis_b_observation";
